...
namespace Classify.Infrastructure.Migrations
{
    ...
    [Migration("20240626224243_AddedIsAprovedPropToPublisherEntity")]
    partial class AddedIsAprovedPropToPublisherEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Classify.Infrastructure.Models.Piece", b =>
                {
                    ...
                    b.Property<string>("AudioFileContentType")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Classify.Infrastructure.Models.Publisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Classify.Infrastructure.Models.Publisher", b =>
                {
                    b.HasOne("Classify.Infrastructure.Models.ApplicationUser", "User")
                        .WithMany()
